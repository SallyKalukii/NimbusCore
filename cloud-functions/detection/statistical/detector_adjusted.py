"""
Statistical Anomaly Detection - Adjusted for Testing
...
class StatisticalDetector:
    ...
    def detect_error_rate_anomaly(self):
        ...
        # Baseline (adjusted for testing environment)
        baseline_mean = 8.0   # 8% error rate is normal for testing
        baseline_std = 3.0    # Standard deviation
    ...
    def detect_volume_anomaly(self):
        ...
        # Baseline (adjusted for testing environment)
        baseline_mean = 100    # Expected 100 logs per hour for testing
        baseline_std = 30      # Standard deviation
